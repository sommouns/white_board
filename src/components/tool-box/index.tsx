import { CardInfo, CARD_TYPE, FiveDescGenerateCard, TopicWordSelectCard } from '@components/recommand-card';
...
export const ToolBox: React.FC = () => {
    ...
    const handleCardClick = (card, idx) => {
        ...
        if (card.type === CARD_TYPE.NORMAL || card.type === CARD_TYPE.REPLACE) {
            dispatch({
                type: eventType,
                id: card.id
            });
